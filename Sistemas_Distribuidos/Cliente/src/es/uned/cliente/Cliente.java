...
//////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private static void login() throws RemoteException {
		...
		do {
			opt = Gui.menu("Bienvenid@", new String[] {  "Registrar un nuevo usuario.",
														 "Autenticarse en el sistema (hacer login).",
														 "Salir"});
	...
	private static void gui() throws RemoteException {
		...
		do {
			opt = Gui.menu("Menu Principal",new String[] {	"Subir fichero.",
															"Bajar fichero.",
															"Borrar fichero.",
															"Número de veces que se ha bajado un fichero.",
															"Listar ficheros.",
...
//////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private static void subirArchivo() throws RemoteException {
	    String rutaArchivo = Gui.input("Subir Archivo", "Ingrese la ruta del archivo a subir (Usar url con doble '\'):");
	...
	private static void listararchivos() throws RemoteException {
	    ...
	    if (archivos.isEmpty()) {
            ...
            for (String archivo : archivos) {
                try {
                    // Obtener el número de descargas para cada archivo
                    int numeroDescargas = servidor.obtenerNumeroDescargas(archivo);  // Asumiendo que este método existe y funciona correctamente

                    // Mostrar el nombre del archivo y su número de descargas
                    System.out.println("Archivo: " + archivo + " - Número de descargas: " + numeroDescargas);
                } catch (RemoteException e) {
                    System.err.println("Error al obtener el número de descargas para " + archivo + ": " + e.getMessage());
                }
            }
	    }
	}
	...
	private static void listarclientes() throws RemoteException {
	    ...
	    List<String> clientes = servidor.listarClientesCliente();
